...
#define AD7124_DEV0	0
#define AD7124_DEV1	1

#define AD7124_CHN_Enable	1
#define AD7124_CHN_Disenable	0
...
uint32_t AC_Volt_Get(uint32_t data);
uint32_t AC_Cur_Get(uint32_t data);
uint32_t AC_Freq_Get(uint32_t data);
