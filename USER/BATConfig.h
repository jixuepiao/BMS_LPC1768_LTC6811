...
#define CeOV_Recovery_Time 				(55*50)		//Cell over Voltage Recovery Delay Time (ms) 电压数值每55ms更新一次
...
#define CeUV_Recovery_Time 				(55*100)	//Cell under Voltage Recovery Delay Time (ms) 电压数值每55ms更新一次
...
#define PkOV_Recovery_Time 				(55*50)		//Pack over Voltage Recovery Delay Time (ms) 电压数值每55ms更新一次
...
#define PkUV_Recovery_Time 				(55*50)		//Pack under Voltage Recovery Delay Time (ms) 电压数值每55ms更新一次
